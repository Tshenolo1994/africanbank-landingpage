...
function OtherServices() {
  return (
<Box display="flex" flexDir="column" gap={6} m={24} h="100%">

     <Box bg="#C6E912"  h="50vh" >

<Box w="100%" display="flex" justifyContent="space-evenly" gap={2} flexDirection="column" p={8} >
<Text fontSize="4xl" fontWeight="400" fontFamily="Altone Trial">Banking</Text>
  ...
  <Button>Learn More</Button>
     ...
     <Box  w="100%" display="flex" justifyContent="space-evenly" gap={2} flexDirection="column" p={8} backgroundColor="rgba(0,24,69, .1)">
<Text fontSize="4xl" fontWeight="400" fontFamily="Altone Trial">Invest</Text>
...
<Box  w="100%" display="flex" justifyContent="space-evenly" gap={4} flexDirection="column" p={12} backgroundColor="rgba(198,233,18, .2)" >
<Text fontSize="4xl" fontWeight="400" fontFamily="Altone Trial">Borrow</Text>
          <Text fontSize="3xl" fontWeight="300">12% interest rates</Text>
  ...
  <Button>Learn More</Button>
     ...
     <Box  background="#140e2e"  h="50vh"  color="#fbfbfb">
